...
ggplot(d1, aes(s1, l1)) +
  ...
  geom_line(data =  d2, aes(s2,l2), color = "#377eb8",linewidth=1) +
  geom_line(data =  d3, aes(s3,l3), color = "#4daf4a",linewidth=1) +
  ...
  annotate("text", x = c(1.25, 61.3), y = c(1.62,2.58), label = c("A", "B"), size=5)+
