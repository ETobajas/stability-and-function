---
title: "The temporal stability in flower visitation rates is driven by the asynchrony of pollinator abundances but does not necesarely explain plant reproductive success stability."
...
1.  The stability of ecological communities over time, often quantified using its aggregated abundance or biomass, is though to be influenced by species richness and the asynchrony of species abundance fluctuations.
    However, the relation between community stability and the stability of the ecosystem functioning provided by this community has been little explored, specially for functions involving several trophic levels such as plant pollination.
...
3.  The stability of plant's visitation rate is driven by the asynchrony of pollinator species abundances but the effect of species richness is only indirect, as richer communities also tend to show more asynchronous populations.
    ...
    A year by year analysis revels that in the studied system plants are unlikely to be limited by pollinator abundances except in specific years, blurring any potential effect of visitation rates stability on the stability of reproductive success.
...
For example, a greater diversity of pollinators has been shown to increase plant reproductive success as a result of complementary in service provision arising from variation of pollinator effectiveness across space and time of the day [@Hoehn2008; @Frund2010; @Albrecht2012; @Bluthgen2011; @Frund2013; @Magrach2021].
...
All this lines of evidence suggest that results found for single year studies should scale up to muti-year stability studies [CITAR GARIBALDI Y SENADAPATY CRFOP STUDIES], but evidence is mostly lacking for natural plant-pollinator systems.
...
We analyze five plant species (*Cistus crispus*, *Cistus ladanifer*, *Cistus salviifolius*, *Halimium halimifolium*, and *Lavandula pedunculata*) that were recorded in at least 5 sites (mean = X sites) in a minimum of two years per site (mean = X years per plant).
...
To examine the role of richness and asynchrony of pollinator species abundances as drivers of stability of visitation rate, we calculate pollinator richness as the total number of diferent pollinator species that visit each plant species in each plot.
...
[ESTEFANIA: Abundance = numero individuos, visitation rate = visitas hechas por esos individuos o usas visitation rate como proxy de abundancias.
Si es lo primero, yo especificaria.
"Note that we calulated abundance as the number of individuals observed, while visitation rate is the sum of their visits" o algo así, quizás tambien en metodos más arriba, mejor ser redundante, sino, o lo dejas así, o clarificas que we use visitation rates as proxies of abundances].
...
*P* values were obtained using the type III Anova (package: car CITAR) as recommended for tetsing interactions.
...
Although this tendency is influenced by a high value in the stability of seed number of *H. halimifolium* (Fig 3B) since when we removed this point the relationship disappears and if anything, show a positive slope (0.561 ± 0.535).
[quito los p val de los tests sin outlyers, para no caer en multiple testing]
