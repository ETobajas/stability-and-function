...
(Garibaldi et al. 2011, Lázaro and Alomar 2019, Hünicken et al 2021, Bishop et al 2022).To the best of our knowledge, how the stability of pollinator community affect to the reproductive success of the wild plant community remaining largely unknown.
...
As the number of pollinator visits received by a plant increases from zero, the reproductive success of the plant is expected to rise initially but then to level off or possibly decline (Young 1988, Young and Young 1992). Bees can remove 70–80% of the pollen that is presented in a flower and a flower's pollen can be exhausted after only a few visits. Therefore, its reproductive success may not continue to increase with increased visitation, but instead may saturate quickly because of pollen depletion (Thomson 2001).
