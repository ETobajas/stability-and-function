...
![ Conceptual figure showing the general relationship between the visitation rate of pollinators and plant reproductive success to different species richness (R1, R2, ...). As the number of pollinator visits increases (V1, V2, …), plant reproductive success is expected to increase until that above a certain threshold, the changes in visitation rates are no longer relevant to plant reproductive success. According to this, A-square shows that temporal variation in plant reproductive success depends on variation in visitation, while B-square shows that reproductive success varies with the variation in richness.](Figures/conceptual_plot.png){width="400"}
...
To that end, we calculated the visitation rate by dividing the total visits observed by the number of flowers observed and by the total observation time (time of each observation multiplied by the number of survey rounds per year).
...
This is an adequate index given that in our dataset, as in most ecological studies, the mean and the variance are scaled to each other.
...
When we analysed each plant species separately, we observed a positive relationship between the asynchrony of pollinators and stability of visitation rate for *C. crispus*, *H. halimifoliun* and *L. pedunculata*, a weak positive relationship for *C. salviifolious* and a weak negative relationship for *C. ladanifer*.
For the relationship with pollinator richness, *C. crispus*, *C. ladanifer* and *C. salviifolius* showed a negative relationship while *H. halimifolium* and *L. pedunculata* showed positive relationships, explaining the overall lack of relationship across all five plants (Supplementary material-Fig 1).
...
When we analysed whether the stability of the pollinator visitation rate affected the stability of plant reproductive success, we found no relationship when fruit proportion was considered (Estimate ± standard error: -1.547 ± 2.611; *p* = 0.558) (Fig 3A).
...
However, in 2018, a specially wet year, the relationship between richness and fruit proportion was negative (Fig 3).
...
However, the relationship between pollinator activity and plant reproductive success is important in certain years.
