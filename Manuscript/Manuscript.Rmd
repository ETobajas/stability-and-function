...
All the analyses of this study were conducted in R ver. 4.0.2. To evaluate the main drivers of visitation rate stability, first we run correlation test between asynchrony and richness. Due to we observed a positive correlation among both variables, linear mixed models were used separately to evaluate the relationships between stability of visitation rate and pollinator richness, and stability of visitation rate and asynchrony of pollinator including site and plant species as random factor. We also asses the relationship between asynchrony and pollinator richness with linear mixed model. For a deeper understanding, we also analyzed the respond of the stability for each plant species separately.
...
Our results showed a significant relationship between stability of visitation rate and asynchrony with greater visitation rate stability when pollinator asynchrony increases (Estimate: 2.903; standard error: 1.134) (Fig 1A),
whereas stability of visitation rate was not influenced by the pollinator richness (Estimate: -0.001; standard error: 0.063) (Fig 1B). We also observed a significant and positive relationship between asynchrony and pollinator richness (Estimate: 0.031; standard error: 0.007) (Supplementary material-Fig 1).
When we analysed the plant species separately, we found no significant differences but we observed positive tendency in asynchrony for *H. halimifolium* and *L. pedunculata*. In the case of richness, *C. crispus*, *C. ladanifer* and *C. salviifolius* was a negative tendecy wile *H. halimifolium* and *L. pedunculata* was positive (Supplementary material-Fig 2).
