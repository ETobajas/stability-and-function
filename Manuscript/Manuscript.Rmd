...
Temporal stability is defined as the capacity of an ecosystem to dampen environmental perturbations over time while retaining ecological functions of interest [@Ives2007; @Pimm1984]. Among main driving of stability are the diversity and species asynchrony. A higher number of species might provide a wider range of responses to environmental changes, which would result in a higher stability [@McCann2000; @Tilman2006; @Hector2010; @Xu2021], although non-significant relationships between diversity and stability have also been observed [@Hooper2005; @VanderPlas2019]. The stability is also influenced by the degree of asynchrony between species. In this sense, higher levels of asynchrony in species fluctuation stabilize the community [@Ruijven2007; @Bluthgen2016; @Craven2018]. It has been also shown that stability can associate more strongly with the degree of synchrony among dominant species than with species richness [@Bluthgen2016; @Valencia2020]. While community temporal stability should be related to the stability of ecosystem functions and services, there is limited evidence linking both processes on multitrophic systems.

Since the reproductive success of most plant species highly depends on pollination by animal [@Ollerton2012], the stability of pollinator communities may increase the stability of plant reproductive success. A greater diversity of pollinators has been shown to increase the plant reproductive success as a result of complementary service provision arising from variation across of pollinator effectiveness, including space and time [@Hoehn2008; @Frund2010; @Albrecht2012; @Bluthgen2011; @Frund2013] (Hoehn et al. 2008; Fründ et al. 2010, Albrecht et al. 2012, Blüthgen and Klein, 2013, Fründ et al. 2013). Pollinator species may exhibit different ranges of temporal activity [@Pisanty2016; @Rader2016] (Pisanty et al. 2016, Rader et al. 2016) and consequently may provide pollination services at different times of the season. 
on the other hand, few studies link the visitation rate directly with plant reproductive but they generally find positive association. Sites with more visitation show higher pollen deposition and fruit set (Garibaldi et al., 2014; Kaiser‐Bunbury et al., 2017).



[gap](I think something about temporal variation and pollen limitation)

Although most plant species rely on animals for pollination, it has calculated that between 60% and 73% of populations suffer significant pollen limitation (Ashman et al. 2004; Burd 1994; Knight et al. 2005)
plants visited by many pollinators species are less pollen limited than those visited by one or few species (Knight et al. 2005), however other research found no relationship between pollinator diversity and pollen limitation (Hegland and Totland 2008; Davila et al 2012)

the occurrence and magnitude of pollen limitation varies among years for individual populations (Burd 1994, Ashman et al. 2004), primarily because of variation in pollinator service (Aizen and Harder 2007). 
